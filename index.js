...
// ✅ Ajustado: aceita números vindos como float/string
function validateClientNumber(n) {
...
app.post('/webhook', (req, res) => {
  ...
  if (intent === 'intent.abrir_chamado') {
    let {
      ...
      numero_cliente, janela_data, janela_hora,
    ...
    if (!validateClientNumber(numero_cliente)) {
      return dfResponse('O número de cliente deve ter 8 dígitos. Pode confirmar?');
    }
